...
class Cloudfront_Cache_Clear {
	 ...
	 * - Cloudfront_Cache_Clear_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cloudfront-cache-clear-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cloudfront-cache-clear-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-cloudfront-cache-clear-admin.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cloudfront-cache-clear-cloudfront.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'delete_post', $cloud_front, 'clear_cloudfront_cache_on_media_delete' );
